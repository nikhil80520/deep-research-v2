...
async def main():
    ...
    # First invocation - should ask for clarification
    ...
    if last_message and hasattr(last_message, 'content') and last_message.content:
        print(f"🤔 Clarification needed: {last_message.content}\n")

        # Now provide the clarification as the user did
        clarification = "mamba 3 research paper new llm archtecture"
        print(f"Your answer: {clarification}\n")
